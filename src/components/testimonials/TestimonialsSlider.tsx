...
export default function TestimonialsSlider() {
  return (
    <>
      <div className='relative hidden w-full items-center justify-between space-x-4 md:flex'>
      ...
      <div className='relative flex w-full flex-col items-center justify-center space-y-7 md:hidden'>
        <div className='relative flex w-full items-center justify-center'>
          <div className='absolute inset-1 z-10 bg-gradient-to-l from-shade-grey-10 via-transparent to-shade-grey-10' />
          <TestimonialItem
            quote='I recently started my own business, and YourBank has been instrumental in helping me set up my business accounts and secure the financing I needed. Their expert guidance and tailored solutions have been invaluable.'
            quoter='John D'
          />
